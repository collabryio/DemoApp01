...
;rfr: # 20230821-Baris-GG-POMS-Clerk id=g14592 corrections
...
;=>
;(["IBM" 10 :order-status/waiting 110000 11000]
; ["HP" 10 :order-status/waiting 119000 11900]
...
(add-new-proposal-status {:id 2 :proposal [:proposal/id 2] :proposal-status :order-approval-status/accepted})
...
;=> (["IBM" 10 110000 11000] ["HP" 10 119000 11900])
...
;=>
;(["IBM" 10 :order-status/waiting 110000 :derived 11000]
; ["HP" 10 :order-status/waiting 119000 :derived 11900]
; ["apple" 20 :order-status/waiting 239000 :derived 11950])
...
;>
;({:supplier "IBM", :amount 10, :order-status :order-status/waiting, :totalprice 110000, :unit-price 11000}
; {:supplier "HP", :amount 10, :order-status :order-status/waiting, :totalprice 119000, :unit-price 11900}
